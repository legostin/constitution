...
|---------|----------|-----------|---------------|
| Global | Определяется платформой/моделью | Высший | Разработчики модели / платформы |
| Enterprise | Определяется провайдером LLM | Высокий | Провайдер LLM / платформа |
| User | `~/.config/constitution/constitution.yaml` | Средний | Пользователь |
| Project | `{cwd}/.constitution.yaml` | Низший | Разработчик проекта |

> Global и Enterprise — зарезервированные уровни. Constitution не создаёт и не ищет конфиги на этих уровнях. Они существуют для совместимости с будущей платформенной инжекцией правил. Вы работаете с **User** и **Project**.
